...
/// 최근 검색어 화면 위젯
///
/// 검색 필드에 포커스가 있을 때 표시되는 최근 검색어 화면입니다.
class SearchRecentSearchesScreenWidget extends ConsumerWidget {
  /// SearchRecentSearchesScreenWidget 생성자
  ///
  /// [searchController]는 검색 필드의 TextEditingController입니다.
  /// [searchFocusNode]는 검색 필드의 FocusNode입니다.
  const SearchRecentSearchesScreenWidget({
