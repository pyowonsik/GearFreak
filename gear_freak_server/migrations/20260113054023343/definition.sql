...
CREATE TABLE "product" (
    ...
    "createdAt" timestamp without time zone,
    "updatedAt" timestamp without time zone,
    "lastBumpedAt" timestamp without time zone,
    "status" bigint
);
...
--
-- Class ProductReport as table product_report
--
...
--
-- Class ProductView as table product_view
--
...
--
-- Class TransactionReview as table transaction_review
--
...
--
-- Foreign relations for "chat_room" table
--
...
--
-- Foreign relations for "product_report" table
--
...
--
-- Foreign relations for "product_view" table
--
...
--
-- Foreign relations for "transaction_review" table
--
