...
# Certificate ARNs are now automatically managed by Terraform (certificates.tf)
# certificate_arn and cloudfront_certificate_arn variables are no longer needed
