...
variable "certificate_arn" {
  description = "Wildcard certificate for the top domain (deprecated - now auto-generated by certificates.tf)"
  type        = string
  default     = ""
}

variable "cloudfront_certificate_arn" {
  description = "Certificate for use with Cloudfront, must be in us-east-1 region (deprecated - now auto-generated by certificates.tf)"
  type        = string
  default     = ""
}
