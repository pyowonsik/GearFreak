  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['chat'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'getTotalUnreadChatCount': _i1.MethodConnector(
          name: 'getTotalUnreadChatCount',
          params: {},
          call: (
            _i1.Session session,
            Map<String, dynamic> params,
              ...
              (endpoints['chat'] as _i4.ChatEndpoint)
                  .getTotalUnreadChatCount(session),
        ),
      },
    );
    ...
    connectors['product'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        ...
        'incrementViewCount': _i1.MethodConnector(
          ...
          call: (
            ...
            Map<String, dynamic> params,
              ...
              (endpoints['product'] as _i7.ProductEndpoint).incrementViewCount(
            session,
            params['productId'],
          ),
        ),
